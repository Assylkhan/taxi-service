...
public class ConnectionPool {
     ...
     */
    public ConnectionPool(int maxPoolSize, int initialPoolSize) throws SQLException {
        this.maxPoolSize = maxPoolSize > 0 ? maxPoolSize : 10;
        this.initialPoolSize = initialPoolSize;
        this.connectionFactory = new ConnectionFactory();
        freeConnections = new LinkedBlockingQueue<PooledConnection>(maxPoolSize);
    ...
    /**
     * checks if pool is not full put new connection in pool
     *
     * @throws java.sql.SQLException
     */
    private synchronized void openAndPutConnection() throws SQLException {
        if (currentPoolSize == maxPoolSize) {
            return;
        }
        boolean put = freeConnections.offer(new PooledConnection(connectionFactory.getConnection()));
        currentPoolSize++;
        log.info("created connection: " + put + ", current pool size: " + freeConnections.size() + ", max size: " +
                currentPoolSize);
    }
    ...
    public void closeConnections() throws SQLException {
        ...
        log.debug("all connections were closed and cleared");
    }
